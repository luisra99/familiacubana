...
function SITUACIÓN_DE_NIÑOS_Y_NIÑAS_Y_ADOLESCENTES() {
  ...
  const siguiente = () => navegar("/servicios-equipamiento/materiales");
    ...
    if (miembros?.length) {
              ...
              <>
                ...
                <TableView
                  ...
                  headers={[
                    ...
                    { name: "autorizacion", align: "center", label: "Autorización del MTSS" },
                  ]}
          ...
          },
          {
            ...
            component: () => (
              <Typography>
                ...
                delito, con comportamiento social inadecuado y/o victimas de
                violencia.
              </Typography>
            ),
            label: "",
      ...
      return (
        <Typography mx={2} my={2}>
          <b>No hay un miembro del hogar seleccionado...</b>
        </Typography>
      );
    }
        ...
        <GenericForm
          ...
          submitFunction={(values) => {
            ...
            if (id) {
              ...
              modificar("dat_nnaocupacion", "idnnaocupacion", id, values).then((id) => {
                notificar({
                  type: "success",
                  title: "Modificado",
